 ...
 * Last Update: 2022-7-21 3:43:59 鈹淔10: PM鈹�
 * Modify by HCLonely
 */
! function (e, t) {
	...
	return n = [function (e, t, n) {
		...
		Array.prototype.forEach || (Array.prototype.forEach = function (e, t) {
			...
			dynamicLoadSource: function (e, t) {
				var n;
				(0, u.default)('script[src="' + e + '"]').length ? t && t() : ((n = c.createElement("script")).onload = n.onreadystatechange = function () {
					this.onload = this.onreadystatechange = null, t && t(), (0, u.default)(n).remove()
		...
		e.exports = function (e) {
			...
			return u && s && u(t, "length").configurable && s(t, "length", {
		...
		t.whiteList = r(), t.getDefaultWhiteList = r, t.onTag = function (e, t, n) {}, t.onIgnoreTag = function (e, t, n) {}, t.onTagAttr = function (e, t, n) {}, t.onIgnoreTagAttr = function (e, t, n) {}, t.safeAttrValue = function (e, t, n, r) {
			...
			return {
				onIgnoreTag: function (e, t, n) {
					var r, o;
					return o = e, u || -1 !== h.indexOf(i, o) ? n.isClosing ? (r = n.position + (o = "[/removed]").length, s.push([!1 !== l ? l : n.position, r]), l = !1, o) : (l = l || n.position, "[removed]") : a(e, t, n)
				},
				remove: function (t) {
					var n = "",
						r = 0;
		...
		function h(e) {
			...
			return e = -1 === t ? e.slice(1, -1) : e.slice(1, t + 1), e = "/" === (e = "/" === (e = d.trim(e).toLowerCase()).slice(0, 1) ? e.slice(1) : e).slice(-1) ? e.slice(0, -1) : e
		}
		...
		t.parseTag = function (e, t, n) {
			...
			function t(e, t) {
				(e = (e = d.trim(e)).replace(v, "").toLowerCase()).length < 1 || (e = n(e, t || "")) && o.push(e)
			}
		...
		*/
		void 0 !== (t = "function" == typeof (r = function (e, t) {
			...
			function n(o) {
				...
				function r() {
					...
					if (n < e ? "hidden" === t.overflowY && (i("scroll"), a(), n = "content-box" === t.boxSizing ? Math.round(parseFloat(window.getComputedStyle(o, null).height)) : o.offsetHeight) : "hidden" !== t.overflowY && (i("hidden"), a(), n = "content-box" === t.boxSizing ? Math.round(parseFloat(window.getComputedStyle(o, null).height)) : o.offsetHeight), l !== n) {
						l = n;
				...
				if (o && o.nodeName && "TEXTAREA" === o.nodeName && !p.has(o)) {
					var u = null,
						...
						c = function (t) {
							window.removeEventListener("resize", e, !1), o.removeEventListener("input", r, !1), o.removeEventListener("keyup", r, !1), o.removeEventListener("autosize:destroy", c, !1), o.removeEventListener("autosize:update", r, !1), Object.keys(t).forEach(function (e) {
								o.style[e] = t[e]
							}), p.delete(o)
						}.bind(o, {
			...
			D = (o.prototype.init = function (e) {
				...
				try {
					var e, t, n, r, o, a = i.cfg,
						...
						y = (0, L.default)(m);
					(m = m instanceof HTMLElement ? m : y[y.length - 1] || null) && (i.$el = (0, L.default)(m), i.$el.addClass("v").attr("data-class", "v"), V.hide && i.$el.addClass("hide-avatar"), i.cfg.meta = (i.cfg.guest_info || i.cfg.meta || I.defaultMeta).filter(function (e) {
						return -1 < I.defaultMeta.indexOf(e)
					}), i.cfg.requiredFields = i.cfg.requiredFields.filter(function (e) {
						return -1 < I.defaultMeta.indexOf(e)
					}), e = (0 == i.cfg.meta.length ? I.defaultMeta : i.cfg.meta).map(function (e) {
						...
						! function t(n) {
							var e, r = n[o++];
							r && (e = (0, L.default)(r).attr("data-xid")) && i.Q(e).count().then(function (e) {
								r.innerText = e, t(n)
							}).catch(function (e) {
								r.innerText = 0
							})
				...
				add: function (t, e) {
					...
					1 === s.length ? (n = s[0], r = decodeURI((0, L.default)(n).attr("id")), o = (0, L.default)(n).attr("data-flag-title"), a = encodeURI(r), i = {
						el: n,
						url: r,
						xid: a,
						title: o
						...
						0 < e.length ? ((e = e[0]).increment("time"), e.save().then(function (e) {
							(0, L.default)(n).find(".leancloud-visitors-count").text(e.get("time"))
				...
				show: function (e, t) {
					...
					t.forEach(function (e) {
						...
						t && t.text("0"), n.push(/\%/.test((0, L.default)(e).attr("id")) ? decodeURI((0, L.default)(e).attr("id")) : (0, L.default)(e).attr("id"))
		...
		o.prototype.Q = function (e) {
				...
				l = (s.$emoji = {
					show: function () {
						if (!u) {
							...
							n.html(t.join("")), u = !0, n.find("i").on("click", function (e) {
								e.preventDefault(), h(i[0], " :" + (0, L.default)(this).attr("title") + ":")
							})
						}
					...
					show: function () {
						return q ? (s.$emoji.hide(), o.addClass("actived"), t.html((0, N.default)(q)).show(), x()) : s.$preview.hide(), s.$preview
					},
					hide: function () {
						return o.removeClass("actived"), t.hide().html(""), s.$preview
					}
				}, function (e) {
					e = e.val() || "";
			...
			for (e in c.forEach(function (e) {
				...
				(p[t] = r).on("input change blur propertychange", function (e) {
					s.cfg.enableQQ && "blur" === e.type && "nick" === t && (r.val() && !isNaN(r.val()) ? (0, P.fetchQQFn)(r.val(), function (e) {
						var t = e.nick || r.val(),
							n = e.qq + "@qq.com";
						(0, L.default)(".vnick").val(t), (0, L.default)(".vmail").val(n), Q.nick = t, Q.mail = n, Q.QQAvatar = e.pic
					}) : L.default.store.get(I.QQCacheKey) && L.default.store.get(I.QQCacheKey).nick != r.val() && (L.default.store.remove(I.QQCacheKey), Q.nick = r.val(), Q.mail = "", Q.QQAvatar = "")), "comment" === t ? ((0, T.default)(r[0]), d(function (e) {
						l(r)
					})()) : Q[t] = (0, U.default)(r.val().replace(/(^\s*)|(\s*$)/g, "").substring(0, 35))
				})
			}();
			var d = function (n) {
				...
				y = (s.Q(s.cfg.path).count().then(function (e) {
					0 < e ? (s.$el.find(".vcount").show().find(".vnum").text(e), m()) : s.$loading.hide()
				}).catch(function (e) {
					(0, M.default)(s, e, "count")
				}), function () {
					var e = (0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : "").match(/(https?|http):\/\/[-A-Za-z0-9+&@#/%?=~_|!:,.;]+[-A-Za-z0-9+&@#/%=~_|]/g) || [];
				...
				b = function (e, t, n) {
					var r = (0, L.default)('<div class="vcard" id="' + e.id + '"></div>'),
						...
						u = L.default.escape((0, U.default)(e.get("nick").substring(0, 30))),
				...
				w = function (i, a) {
					i.on("click", function (e) {
						...
						(0, L.default)('.vreply-wrapper[data-self-id="' + n + '"]').append(r).find(".cancel-reply").show(), D = {
			...
			if (k = L.default.store.get(I.MetaCacheKey) || k)
				for (var E in c) c.hasOwnProperty(E) && (E = c[E], s.$el.find(".v" + E).val(L.default.unescape(k[E])), Q[E] = k[E]);

			function F(e) {
				if (-1 < s.cfg.requiredFields.indexOf("nick") && Q.nick.length < 3) return p.nick[0].focus(), void s.$el.find(".status-bar").text("" + s.i18n.t("nickFail")).empty(3e3);
				if (-1 < s.cfg.requiredFields.indexOf("mail") && !/^[a-zA-Z0-9.!#$%&'*+\/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*$/.test(Q.mail)) return p.mail[0].focus(), void s.$el.find(".status-bar").text("" + s.i18n.t("mailFail")).empty(3e3);
				if ("" == q) p.comment[0].focus();
					...
					r && Date.now() / 1e3 - r / 1e3 < 20 ? s.$el.find(".status-bar").text(s.i18n.t("busy")).empty(3e3) : O()
				}
			}
			var C = L.default.store.get(I.QQCacheKey),
				_ = (Q.QQAvatar = s.cfg.enableQQ && !!C && C.pic || "", s.reset = function () {
					Q.comment = "", p.comment.val(""), l(p.comment), p.comment.attr("placeholder", s.cfg.placeholder), D = {}, s.$preview.hide(), s.$el.find(".vpanel").append(s.$el.find(".vwrap")), s.$el.find(".cancel-reply").hide(), q = "", T.default.update(p.comment[0])
				}, s.$el.find(".vsubmit")),
				S = function () {
					var e = new AV.ACL;
				...
				O = function () {
					...
					r.setACL(S()), r.save().then(function (e) {
						...
						try {
							D.rid ? b(e, (0, L.default)('.vquote[data-self-id="' + D.rid + '"]'), !0) : ((Number(t.text()) ? t : s.$el.find(".vcount").show().find(".vnum")).text(Number(t.text()) + 1), b(e, s.$el.find(".vcards")), g.skip++), _.removeAttr("disabled"), s.$loading.hide(), s.reset()
						} catch (e) {
				...
				B = (_.on("click", F), (0, L.default)(document).on("keydown", function (e) {
		...
		n.code = function (e, t) {
			...
			highlight: function (e, t) {
				return "hljs" in window ? t && hljs.getLanguage(t) && hljs.highlight(t, e, !0).value || hljs.highlightAuto(e).value : (0, i.default)(e)
			},
			gfm: !0,
			tables: !0,
			breaks: !0,
		...
		t.__esModule = !0, t.default = function (e, t) {
			...
			try {
				...
				var r, o, i, a, u, s = (new Date).getTime() - n,
		...
		var n = n(47),
			...
			o = (t.default = function (f) {
				return f = (0, r.default)({
					...
					var n, r, o, i;
					if ("jsonp" == f.method) return n = "cb_" + (Date.now() + Math.round(1e3 * Math.random())).toString(32), r = document, o = r.body, (i = r.createElement("script")).async = !0, i.defer = !0, -1 < f.url.indexOf("?") ? f.url += "&" + d({
						callback: n,
						t: Date.now()
					}) : f.url += "?" + d({
						callback: n,
		...
		function u(e, t, n) {
			return n = Object.create(u.fn), e && n.push.apply(n, e[i] ? [e] : "" + e === e ? /</.test(e) ? ((t = o.createElement(t)).innerHTML = e, t.children) : t ? (t = u(t)[0]) ? t[a](e) : n : o[a](e) : e), n
		}
		...
		e.exports = function (r, o) {
			function e() {
				var e, t, n;
				i || -1 !== (t = (e = c.trim(r.slice(a, u))).indexOf(":")) && (n = c.trim(e.slice(0, t)), t = c.trim(e.slice(t + 1)), n && (n = o(a, s.length, n, t, e)) && (s += n + "; ")), a = u + 1
			}
		...
		e.exports = function (t) {
			...
			return n.prototype && ((a = function () {}).prototype = n.prototype, u.prototype = new a, a.prototype = null), u
		}
	}, function (e, t, n) {
		e.exports = function () {
			"use strict";
			...
			return function (e, t) {
				...
				var a = 0,
					...
					n = /[\u4E00-\u9FFF\u3400-\u4dbf\uf900-\ufaff\u3040-\u309f\uac00-\ud7af\u0400-\u04FF]+|\w+/,
					r = /</,
					o = new RegExp("(" + n.source + "|" + r.source + ")|(" + l().source + ")", "gmi");
		...
		! function (r) {
			...
			var A = /[&<>"']/,
					...
					return t.space = function (e) {
							...
							for (a = 0; a < b; a++) {
								...
								var D = v.items[a].tokens.filter(function (e) {
									...
									w = D.every(function (e) {
										for (var t, n = e.raw.split(""), r = 0, o = x(n); !(t = o()).done;)
						...
						if (t) {
							...
							if (n.header.length === n.align.length) {
								...
								for (u = n.rows.length, r = 0; r < u; r++) n.rows[r] = f(n.rows[r], n.header.length).map(function (e) {
									return {
										text: e
									}
								});
				...
				B = (O.punctuation = u(O.punctuation).replace(/punctuation/g, O._punctuation).getRegex(), O.blockSkip = /\[[^\]]*?\]\([^\)]*?\)|`[^`]*?`|<[^>]*?>/g, O.escapedEmSt = /\\\*|\\_/g, O._comment = u(S._comment).replace("(?:--\x3e|$)", "--\x3e").getRegex(), O.emStrong.lDelim = u(O.emStrong.lDelim).replace(/punct/g, O._punctuation).getRegex(), O.emStrong.rDelimAst = u(O.emStrong.rDelimAst, "g").replace(/punct/g, O._punctuation).getRegex(), O.emStrong.rDelimUnd = u(O.emStrong.rDelimUnd, "g").replace(/punct/g, O._punctuation).getRegex(), O._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g, O._scheme = /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/, O._email = /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/, O.autolink = u(O.autolink).replace("scheme", O._scheme).replace("email", O._email).getRegex(), O._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/, O.tag = u(O.tag).replace("comment", O._comment).replace("attribute", O._attribute).getRegex(), O._label = /(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/, O._href = /<(?:\\.|[^\n<>\\])+>|[^\s\x00-\x1f]*/, O._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/, O.link = u(O.link).replace("label", O._label).replace("href", O._href).replace("title", O._title).getRegex(), O.reflink = u(O.reflink).replace("label", O._label).replace("ref", S._label).getRegex(), O.nolink = u(O.nolink).replace("ref", S._label).getRegex(), O.reflinkSearch = u(O.reflinkSearch, "g").replace("reflink", O.reflink).replace("nolink", O.nolink).getRegex(), O.normal = p({}, O), O.pedantic = p({}, O.normal, {
					...
					link: u(/^!?\[(label)\]\((.*?)\)/).replace("label", O._label).getRegex(),
					reflink: u(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label", O._label).getRegex()
				}), O.gfm = p({}, O.normal, {
				...
				}), O.gfm.url = u(O.gfm.url, "i").replace("email", O.gfm._extended_email).getRegex(), O.breaks = p({}, O.gfm, {
					br: u(O.br).replace("{2,}", "*").getRegex(),
					text: u(O.gfm.text).replace("\\b_", "\\b_| {2,}\\n").replace(/\{2,\}/g, "*").getRegex()
				}), function () {
					function n(e) {
				...
				H = (w.options = w.setOptions = function (e) {
					...
					for (var p, t = x(e); !(p = t()).done;) ! function () {
						var t = p.value;
						switch (c.call(w, t), t.type) {
							case "table":
								...
								for (var o, i = x(t.rows); !(o = i()).done;)
									for (var a, u = o.value, s = x(u); !(a = s()).done;) {
										var l = a.value;
				...
				}, w.Parser = z, w.parser = z.parse, w.Renderer = $, w.TextRenderer = j, w.Lexer = B, w.lexer = B.lex, w.Tokenizer = _, w.Slugger = T, (w.parse = w).options),
				Z = w.setOptions,
				K = w.use,
				G = w.walkTokens,
				J = w.parseInline,
		...
		*/
		...
		var n = "function" == typeof Map && Map.prototype,
			...
			s = (e.exports = function r(n, e, o, i) {
				...
				if ("function" == typeof n) return "[Function" + ((t = (t = n).name || ((t = J.call(G.call(t), /^function\s*([\w$]+)/)) ? t[1] : null)) ? ": " + t : " (anonymous)") + "]" + (0 < (t = _(n, a)).length ? " { " + P.call(t, ", ") + " }" : "");
		...
		var o, i = n(31),
			a = n(32),
			u = n(96);
		for (o in (t = e.exports = r).filterXSS = r, t.FilterXSS = u, i) t[o] = i[o];
		for (o in a) t[o] = a[o];
		...
		function r(e) {
			(e = function (e) {
				...
				for (t in e) n[t] = e[t];
				return n
			}(e || {})).stripIgnoreTag && (e.onIgnoreTag, e.onIgnoreTag = i.onIgnoreTagStripAll), e.whiteList = e.whiteList || e.allowList || i.whiteList, e.onTag = e.onTag || i.onTag, e.onTagAttr = e.onTagAttr || i.onTagAttr, e.onIgnoreTag = e.onIgnoreTag || i.onIgnoreTag, e.onIgnoreTagAttr = e.onIgnoreTagAttr || i.onIgnoreTagAttr, e.safeAttrValue = e.safeAttrValue || i.safeAttrValue, e.escapeHtml = e.escapeHtml || i.escapeHtml, !1 === (this.options = e).css ? this.cssFilter = !1 : (e.css = e.css || {}, this.cssFilter = new o(e.css))
		}
		var o = n(7).FilterCSS,
			i = n(31),
			a = n(32),
		...
		r.prototype.process = function (e) {
			...
			var t = this.options,
				...
				t = (t.stripIgnoreTagBody && (l = (n = i.StripTagBody(t.stripIgnoreTagBody, l)).onIgnoreTag), v(e, function (e, t, o, n, r) {
					e = {
						sourcePosition: e,
						position: t,
						isClosing: r,
